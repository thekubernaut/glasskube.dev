...
<div style={{textAlign: "center"}}><em>Fig 1: The CVE assignment and documentation process</em></div>
...
<div style={{textAlign: "center"}}><em>Fig 2: Components of the CVSS scoring system</em></div>
...
<div style={{textAlign: "center"}}><em>Fig 3: The vulnerability management lifecycle</em></div>
